...
export default function ValuesSection() {
  return (
    <section id="values" className="py-20 bg-beige overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
          {values.map((value, index) => (
            ...
            >
              <div
                className={`relative bg-white rounded-xl p-8 shadow-lg h-full flex flex-col transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 border-l-4 ${
                  value.accent === "forest"
                    ? "border-l-forest"
                    : "border-l-brown"
                }`}
